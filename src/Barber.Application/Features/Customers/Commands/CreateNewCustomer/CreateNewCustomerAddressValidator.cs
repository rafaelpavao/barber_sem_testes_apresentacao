...
namespace Barber.Application.Features.Customers.Commands.CreateNewCustomer;

public class CreateNewCustomerAddressValidator : AbstractValidator<AddressToCreateDto>{
  public CreateNewCustomerAddressValidator(){
    RuleFor(a => a.CEP)
